#!/usr/bin/env python3
"""
Echo3D Hybrid – unified script with local/global/mixed modes.
...
CONFIG: Dict = {
    ...
    # pose behavior
    "learn_pose": True,               # canonical pose default; used in local/mixed
...
# ============================================================
# GLOBAL DATASET STRUCTURE (for global/mixed modes)
# ============================================================
