...
CONFIG: Dict = {
    ...
    "split_ratios": {"train": 0.6, "val": 0.20, "test": 0.20},
    ...
    # pose behavior
    "learn_pose": False,          # canonical pose default
...
# ============================================================
# Differentiable projection: INR -> planar slice
# ============================================================
...
def main() -> None:
    ...
    # -----------------------------
    # Main per-scan optimization loop
    # -----------------------------
    for split in splits_to_run:
        print("\n" + "=" * 60)
            ...
            for img_file, label_file in scans:
                ...
                try:
                    ...
                    try:
                        ...
                        print(
                            "Skipping scan due to strict-slice selection failure:", e
                        )
                        continue
                    ...
                    csv_rows.append(
                        {
                            ...
                            "z_indices": ";".join(str(z) for z in chosen),
                        }
                    )
