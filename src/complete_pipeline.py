#!/usr/bin/env python3
"""
COMPLETE PIPELINE - RECONSTRUCTION + 3D COMPARISON
==================================================
...
# ============================================================================
# 3D COMPARISON VIEWER (From viewer_3d_production_ready.py)
# ============================================================================
...
class PreciseThreeDComparator:
    ...
    def create_comparison_viewer(self, subject_id, img_file, label_file):
        ...
        camera = dict(eye=dict(x=1.3, y=1.3, z=1.3), aspectmode='cube')
    ...
    def create_overlay_viewer(self, subject_id, img_file, label_file):
        ...
        fig.update_layout(
            ...
            scene=dict(camera=camera, aspectmode='cube'),
            height=900,
            width=900,
            showlegend=True,
            template='plotly_white'
...
def main():
    print("="*70)
    print("COMPLETE PIPELINE: RECONSTRUCTION + 3D COMPARISON")
    print("="*70)
    ...
    print(f"\nOPEN IN BROWSER:")
    print(f"  - *_comparison.html")
    print(f"  - *_overlay.html")
    print("="*70)
