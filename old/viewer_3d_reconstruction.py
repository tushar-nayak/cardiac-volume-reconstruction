# #!/usr/bin/env python3
# """
# 3D VIEWER - SIDE-BY-SIDE COMPARISON
...
#     def create_3d_mesh_trace(self, vertices, faces, color='blue', name='Surface'):
...
#             original_seg, threshold=0.5, max_points=20000
#         )
        
#         print(f"  Extracting reconstructed surface...")
#         recon_vertices, recon_faces = self.extract_surface_points(
#             reconstructed, threshold=np.mean(reconstructed), max_points=20000
#         )
...
#             orig_vertices, orig_faces, color='#1f77b4', name='Original'
#         )
...
#             recon_vertices, recon_faces, color='#ff7f0e', name='Reconstructed'
#         )
...
#         print("="*70)
#         print("3D COMPARISON VIEWER GENERATOR")
#         print("="*70)
...
#                 self.create_comparison_viewer(subject_id, img_file, label_file)
...
#             print(f"Mean IoU: {np.mean([m['iou'] for m in all_metrics]):.4f}")
#             print(f"Mean Volume Ratio: {np.mean([m['volume_ratio'] for m in all_metrics]):.4f}")
#             print("="*70)
...
#         print(f"\nOpen HTML files in your web browser for interactive 3D exploration!")
